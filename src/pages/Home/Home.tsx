  ...
  <>
    <div className="cardWrapper">
      <div className="card bg-card card-height w-full md:w-3/12 mx-auto flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl">
        ...
        <Link to="/question" className="py-10 flex items-center -mx-1 text-sm text-blue-500 capitalize transition-colors duration-200 transform hover:underline hover:text-blue-600">
